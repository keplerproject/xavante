...
--
-- $Id: t_kepler_init.lua,v 1.1 2006/08/10 21:23:19 mascarenhas Exp $

-- Lua 5.0 paths 
local conf50    = [[XAVANTE_CONF]]
local luabase50 = [[LUABASE]]
local libbase50 = [[LIBBASE]]

-- Lua 5.1 paths
local conf51    = [[XAVANTE_CONF]]
local luabase51 = [[LUABASE]]
local libbase51 = [[LIBBASE]]
...
elseif string.find (_VERSION, "Lua 5.1") then
  package.path = expandPath(conf51, luabase51)
